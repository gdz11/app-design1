...
2. Create a Component Breakdown Diagram:  
  Design a visual representation of how the website can be structured in terms of components. This can be a simple sketch or a digital wireframe, clearly showing how each part of the page will be handled by a specific component. Alternatively, you can outline component borders on a screenshot of the website/app (see the provided example: Component_example_v2.png). Each team should break down at least three pages of the given website, with each team member responsible for at least one page.
3. Presentation:  
